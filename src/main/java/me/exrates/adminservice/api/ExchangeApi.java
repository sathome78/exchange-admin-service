...
import me.exrates.adminservice.exceptions.ExchangeApiException;
...
public class ExchangeApi {
    ...
    public List<RateDto> getRatesFromApi() {
        ...
        try {
            responseEntity = restTemplate.exchange(url + "/all", HttpMethod.GET, new HttpEntity<>(getAuthHeaders()), ExchangeData.class);

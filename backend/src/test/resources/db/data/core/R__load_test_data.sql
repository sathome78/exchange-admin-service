...
INSERT IGNORE INTO USER_ROLE (id, name, user_role_business_feature_id, user_role_group_feature_id, user_role_report_group_feature_id) VALUES
...
INSERT IGNORE INTO USER (id, pub_id, nickname, email, password, regdate, phone, finpassword, status, ipaddress, roleid, preferred_lang, avatar_path, tmp_poll_passed, login_pin, use2fa, 2fa_last_notify_date, withdraw_pin, transfer_pin, temporary_banned, change_2fa_setting_pin, api_token_setting_pin, GA, kyc_verification_step, kyc_status, kyc_reference, country, firstName, lastName, birthDay)
    VALUE
    ...
    (2, 'SIAAWWASADDWDDWAW','admin1','admin1@exrates.me', '$2a$10$ywda3/fTYHWR6E9e9KXUj.5tB3xFO1jdIBJs3BLpO6ORRSJZMg3v.', '2019-04-16 10:05:29', '+380672223344', null, 2, '127.0.0.1', 1, 'en', null, 1, null, 0, null, null, null, 0, '$2a$10$oyFeDvhk55fpvUKxvtcsI.zrUC669qcnN1iB4QMjY2obPgxLSQOR.', null, 'GA1.2.1627413492.1555445430', 0, 'success','none', 'UK', 'Charles', 'James',  null),
    (3, 'JHGGGJHGJHGHGJGJG','user','user@exrates.me', '$2a$10$ywda3/fTYHWR6E9e9KXUj.5tB3xFO1jdIBJs3BLpO6ORRSJZMg3v.', '2019-04-16 10:05:29', '+380672223344', null, 2, '127.0.0.1', 4, 'en', null, 1, null, 0, null, null, null, 0, '$2a$10$oyFeDvhk55fpvUKxvtcsI.zrUC669qcnN1iB4QMjY2obPgxLSQOR.', null, 'GA1.2.1627413492.1555445430', 0, 'none','none', null, null, null,  null);

INSERT IGNORE INTO OPERATION_TYPE (id, name, description) VALUES (1, 'Input', null),
                                                          (2, 'Output', null),
                                                          (3, 'sell', null),
                                                          (4, 'buy', null),
...
INSERT IGNORE INTO CURRENCY (id, name, description, hidden, max_scale_for_refill, max_scale_for_withdraw, max_scale_for_transfer, process_type, scale) VALUES
...
INSERT IGNORE INTO WALLET (id, currency_id, user_id, active_balance, reserved_balance, ieo_reserve) VALUES
(1, 4, 1, 100000000, 0, 0),
...
INSERT IGNORE INTO TRANSACTION (id, user_wallet_id, currency_id, amount, commission_amount, source_type, operation_type_id, source_id) VALUES
(1, 1, 4, 1.0, 0.1, 'REFILL', 1, 1),

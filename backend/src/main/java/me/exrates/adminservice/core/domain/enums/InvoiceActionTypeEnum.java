...
import me.exrates.adminservice.core.exceptions.AuthorisedUserIsHolderParamNeededForThisActionException;
import me.exrates.adminservice.core.exceptions.AvailableForCurrentContextParamNeededForThisActionException;
import me.exrates.adminservice.core.exceptions.InvoiceActionIsProhibitedForCurrencyPermissionOperationException;
import me.exrates.adminservice.core.exceptions.InvoiceActionIsProhibitedForCurrentContextException;
import me.exrates.adminservice.core.exceptions.InvoiceActionIsProhibitedForNotHolderException;
import me.exrates.adminservice.core.exceptions.PermittedOperationParamNeededForThisActionException;
import me.exrates.adminservice.core.exceptions.UnsupportedInvoiceActionTypeNameException;

import java.util.Arrays;
import java.util.List;
import java.util.stream.Collectors;

import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.ACCEPT_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.ACCEPT_HOLDED_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.CONFIRM_ADMIN_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.CONFIRM_USER_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.DECLINE_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.DECLINE_HOLDED_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.POST_HOLDED_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.RETURN_FROM_WORK_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.REVOKE_ADMIN_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.REVOKE_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.SHOW_CODE_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceActionTypeButtonEnum.TAKE_TO_WORK_BUTTON;
import static me.exrates.adminservice.core.domain.enums.InvoiceOperationPermission.ACCEPT_DECLINE;
